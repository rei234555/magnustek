  ...
  return (
    <section className="w-full overflow-hidden text-white bg-white">
      ...
      <section className="px-2 py-10 bg-white text-black">
          ...
          {currentProducts.map((product, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <button
                  className="mt-auto text-xs bg-[#F46F22] text-white px-4 py-2 rounded-xl hover:bg-white hover:text-[#F46F22] hover:border-1 transition"
                  onClick={() => navigate("/detail/detail-kiosk")}
                >
                  Beli Sekarang
                </button>
              </div>
        ...
        {/* Pagination Section */}
        <section className="bg-white border-b border-[#4E2C83] py-8">
          <div className="max-w-7xl mx-auto px-4">
