...
const EditProfile = () => {
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 overflow-y-auto">
      <section className="bg-white rounded-xl shadow-md border border-[#F46F22] p-6 flex flex-col md:flex-row items-start justify-start relative">
        {showNotification && (
        ...
        <div className="flex flex-col md:flex-row items-start gap-8 w-full">
          {/* Foto Profil */}
          <div
            className="flex flex-col items-center w-full md:w-[300px]"
          ...
          >
            ...
            <p className="text-xs text-center text-gray-500 mt-1 max-w-xs">
